...
describe('get-start-point', () => {
  ...
  it('from top right', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'top right' })
    )
  ...
  it('from bottom right', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'bottom right' })
    )
  ...
  it('from bottom left', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'bottom left' })
    )
  ...
  it('from bottom center', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'bottom center' })
    )
  ...
  it('from top center', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'top center' })
    )
  ...
  it('from left center', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'left center' })
    )
  ...
  it('from right center', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'right center' })
    )
  ...
  it('from center center', () => {
    const result = getStartPoint(
      Object.assign({}, opts, { start: 'center center' })
    )

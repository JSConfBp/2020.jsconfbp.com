...
export default ({ className, polygonClassName }) => (<div className={ classnames(css.wrap, className) }>
  <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
    ...
    <g id="JS" transform="translate(0.000000,1052.000000) scale(0.100000,-0.100000)">
      <path d="M4685.2,7142.5c-156.2-12.4-287.3-68.6-384.8-165.3C4200,6877.5,4152,6756,4152,6601.9c0-230.6,94.7-391.8,305.9-519.6
      ...
      <path d="M3398.5,6391.5l-1.2-730.8l-9.1-34.3c-12-45.1-26-71.9-50.8-96.7c-34.7-34.7-79.4-49.2-153.8-49.6

...
export default () => {
  ...
  >
    ...
    <p>
      ...
      every year so far, we'll provide several free, Scholarship tickets to help
      underrepresented groups in tech to attend the conference.
    </p>
    ...
    <p>
      This Scholarship is made for you if you wished to attend JSConf Budapest,
      but you could not afford it for some reason.
    </p>
    ...
    <p>
      Scholarship Support is not money for a party, nor for fancy catering, or a
      nice booth.
    </p>
    ...
    <p>
      ...
      region, and we are working hard, to make this event available for everyone
      who is interested. But we know many in the region would, but cannot attend
      such a conference, for various reasons. They can get a ticket to the
      event, through the Scholarship.
    </p>
    ...
    <p>
      ...
      application procedure. Along with personal details for the tickets itself,
      we ask applicants a few questions about what they do in tech or what they
      wish to learn on the event. These answers are helpful for the jury, who
      will evaluate the applications and award the tickets.
    </p>
    ...
    <p>
      ...
      applications and select the awardees. To manage the scholarship budget, we
      turned to the Asimov Foundation in Budapest, who helped the people chosen
      with travel arrangements if necessary. This year, we plan to cooperate
      with these organizations again.
    </p>

    <h4>Green Fox Academy</h4>

    <p>
      Green Fox Academy is a school of technology in Budapest where students are
      provided with marketable knowledge. Their philosophy is reflected in the
      education principles they apply during the courses. They genuinely believe
    ...
    <p>
      The goals of Asimov Foundation in Budapest are to broaden the professional
      horizon in IT, to give inspiration and to connect the members of the
      community with each other. To facilitate genuine dialogue and sharing of
      information and knowledge among technologists through our events. To
      encourage innovative activities and effective professional cooperation
      among IT developer groups.
      <br />
      <br />
      More information:{' '}

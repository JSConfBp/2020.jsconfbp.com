  ...
  return (
    ...
    >
      ...
      <p>
        ...
        upcoming JSConf Budapest (September 23-24, 2021, Budapest, Hungary).
      </p>
      <p>
      ...
      <p>
        In the feedback for our last CFP, we read that using a CFP service or
        site is preferred for some of you. We've looked around, and found one
        which we can use together with our CFP evaluation tools.
      </p>
      <p>
        To help those who like to manage their talks in this way, we're
        accepting CFPs not just through Google Forms, but through Sessionize as
        well.
      </p>
      ...
      <p>
        ...
        abstracts - for such details, we provide a separate field on the CFP
        form, which we'll check when we de-anonimize the talks at the end of the
        evaluation process.
      </p>
      ...
      <ul>
        <li>
          How did the web help us get through COVID. Tools, services that made
          it easier to cope with the many aspects of a world-wide pandemic.
        </li>
        <li>
      ...
      <p>
        ...
        ask you to help us. Omit any detail, url, company name from your the
        title and abstracts - for such details, we provide a separate field on
        the CFP form.
      </p>
      ...
      <p>
        ...
        Budapest at the same venue we did last time in 2019. We'll do our best
        to make this experience as safe as possible for every participant:
        speakers, attendees and sponsors alike.
      </p>
      <p>
        ...
        2021, the situation will be manageable and visiting events like ours
        will be possible.
      </p>
      <p>
        Don't be discouraged by this situation, feel free to submit all your
        talk ideas, you have nothing to lose by submitting. We'll see how the
        situation develops in 2021, and work out the details together with the
        authors of the selected talks.
      </p>

...
const CFPButton = () => (
  <Button
    ...
    fill={true}
    color={'purple'}
    href={'https://docs.google.com/forms/d/e/1FAIpQLSdtRwZkaXoPcNleNCpQHswgImy9ez92yoGmPfWvbd-ZrNOt2A/viewform'}
  >
    Submit your talk!
  </Button>
)
...
const CallForSpeakers = () => (
  ...
  >
    ...
    <p>
        ...
        upcoming JSConf Budapest (September 24-25, 2020, Budapest, Hungary).
      </p>
      <p>
        This Call for Speakers closes on{' '}
        <strong>February 29th, 2020</strong>!
      </p>
      ...
      <p>
        We're aiming at the most bias-free selection process as possible, so we ask you to help us.
        Omit any detail, url, company name from your the title and abstracts - for such details, we provide a separate field on the CFP form.
      </p>
      ...
      <ul>
        ...
        <li>
          The top-N (~90) submissions are rated again on a 3-point scale.
        </li>
        <li>
          Then we de-anonymize the final shortlist so we can bias against speaker details

...
lead: "We keep to the original schedule and aim to the original dates, with no delay, and no cancellation."
...
Still, end of September looks good, but we have to prepare a plan B and C for more pessimistic scenarios, namely:
...
- CFP evaluation is happening, the results will be annouced,
- [regular tickets are available](https://ti.to/jsconf-bp/jsconf-budapest-2020),
- [the Scholarship Program is opened](/scholarship).

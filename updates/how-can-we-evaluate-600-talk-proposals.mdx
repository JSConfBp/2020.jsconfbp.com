...
socialCard: "cfp_post.jpg"
---
import Button from '../src/components/Button'
import PostImage from '../src/components/PostImage'

From time to time we receive feedback, that the use of Google Forms as a CFP input can be tedious for speakers.
The reasons behind these concerns are unfortunately true.  For example, to copy/paste similar fields all the time
and keeping track of spontaneous updates in the abstract can be an overhead for those who like to keep a speaker profile,
...
_ps.: Our CFP is still open, and we would love to hear about your talk ideas!_
